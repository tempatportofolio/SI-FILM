...
<div class="copy-right">
	...
	<!---->
	<!--scrolling js-->
	<script type="text/javascript" src="<?php echo e(asset('admin/js/jquery.nicescroll.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('admin/js/scripts.js')); ?>"></script>
	<!--//scrolling js-->
</body>
</html>
...
--><?php /**PATH C:\xampp\htdocs\sifilm\resources\views/auths/login.blade.php ENDPATH**/ ?>